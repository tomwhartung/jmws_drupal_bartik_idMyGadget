 ...
 */
function bartik_idMyGadget_preprocess_html(&$variables) {
 ...
 */
function bartik_idMyGadget_process_html(&$variables) {
 ...
 */
function bartik_idMyGadget_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function bartik_idMyGadget_preprocess_maintenance_page(&$variables) {
 ...
 */
function bartik_idMyGadget_process_maintenance_page(&$variables) {
  // Always print the site name and slogan, but if they are toggled off, we'll
  // just hide them visually.
  $variables['hide_site_name']   = theme_get_setting('toggle_name') ? FALSE : TRUE;
  $variables['hide_site_slogan'] = theme_get_setting('toggle_slogan') ? FALSE : TRUE;
 ...
 */
function bartik_idMyGadget_preprocess_node(&$variables) {
 ...
 */
function bartik_idMyGadget_preprocess_block(&$variables) {
 ...
 */
function bartik_idMyGadget_menu_tree($variables) {
 ...
 */
function bartik_idMyGadget_field__taxonomy_term_reference($variables) {
  $output = '';
